...
<h1 align="center">HCW Marketplace</h1>
...
- The name "MarketU" is also copyright protected and should be changed to the name of your market.
...
MarketU comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
